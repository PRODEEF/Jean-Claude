...
Dernière mise à jour : **9 septembre 2026** — Jean-Claude peut désormais
...
**Jean-Claude peut signaler un bug depuis le canal permanent, retenu comme
suggestion à valider (A.10).** Jusqu'ici, remonter un avis passait
uniquement par la fenêtre d'avis général (posée le 4 septembre) — un geste
