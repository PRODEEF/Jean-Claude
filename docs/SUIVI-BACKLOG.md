...
Dernière mise à jour : **31 août 2026** — fin du setup initial.
...
| §4.4 | React Native | ✅ | Expo SDK 52, Expo Router |
...
|---|---|:--:|---|
| §6.1 | E-mail + code à usage unique | 🔵 | Écran de connexion + `AuthProvider` faits ; à tester contre une vraie instance Supabase |
